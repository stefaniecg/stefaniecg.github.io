...
The audience ('_the type of Lost_') we encounter are in great majority atheist (deny the existence and belief in God), then agnostics (do not know if there is a God, but do not deny nor assert it), followed by muslims, catholics, Jehova's witness, and one time a jewish person.
...
Jesus Ministry of building a disciple-making movement has 6 phases, each phase starts with a milestone.
The ministry building process is illustrated in _Figure 1_.
His _disciple-making process_ took un-believers (_The lost_) and turned them into not only disciples, but _disciple-makers_.
The end stage of every human is to turn from being in the status of '_lost_' to the status of '_disciple-maker_'.
For people to move from one stage to another, there is a specific calling Jesus Christ used.
The latter process is presented in _Figure 2_.
These two charts shown in Figure 1 and 2, are related through the diagram shown in _Figure 3_.
...
- **Method**:
   ...
   3. Invite them to think about what we spoke and invite them to consider meeting us for 5 _Alef bible discovery_ sessions. They will take the invitation, which includes the contact information to reach us via email address or phone number.  
...
- **Structure of bible discovery meetings**:
   ...
   2. **Retrospective** (to last session) - [Ruckblick]
      ...
      * Pray for the people mentioned. Ask God what He is doing.
   3. **Scripture** - [Lesen]
...
| M3  | material production    | ?          | Print invitations and set-up contact email address              |
| M4  | selective feedback     | ?          | Peer-review: Ask for feedback to selected peers                 |
...
* **Central topic**: Based on the elementary doctrines in [Hebrews 6:1-2 ](https://my.bible.com/bible/59/HEB.6.1-2).
* **Expected learning outcome**: Stand firm in elementary doctrines of Christianity, only after baptism.
* **Moderator**: We all rotate the leading of the session with pre-prepared questions, including participants.
